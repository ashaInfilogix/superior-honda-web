...
@section('content')
                                    ...
                                    <div class="product__wrapper">
                                        <div class="row mb--n30">
                                            @foreach($productData as $key => $value)
                                                ...
                                                <article class="product__card">
                                                    <div class="product__card--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="javascript:void(0)">
                                                            @php $i = 1; @endphp
   ...
   $(document).on('click', '.remove-from-cart', function(e) {
    ...
    var minicartProduct = buttonevent.closest('.minicart__product');
    ...
    var totalAmountElem = $('.totalAmount b');
    var grandTotalElem = $('.grandTotal b');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    var cartCount = parseInt($('.item-count-cart').text());
                    console.log('Cart Count Before: ' + cartCount);
                    if (!isNaN(cartCount)) {
                        cartCount--;
                        $('.item-count-cart').text(cartCount > 0 ? cartCount : 0);
                        console.log('Cart Count After: ' + (cartCount > 0 ? cartCount : 0));
                    }
                }
            }
        });
