            ...
            <div class="row ">
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Smartphone ablet</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Computer Laptop</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">TV & Audio</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Car Accessories</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Cameras Photos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <div class="footer__logo">
                    <a class="footer__logo--link" href="{{ route('index')}}"><img src="{{ asset('assets/images/logo/nav-log.webp') }}" alt="logo-img"></a>
                </div>
