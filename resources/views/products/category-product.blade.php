            ...
            <div class="container">
                <div class="row">
                        <div class="shop__right--sidebar">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                        <article class="product__card">
                                                            ...
                                                            <div class="product__card--content">
                                                                ...
                                                                <h3 class="product__card--title"><a href="#">{{ ucwords($product->product_name) }} </a></h3>
                                                    ...
                                                    <div class="col mb-30">
                                                        <div class="product__card product__list d-flex align-items-center">
                                                            ...
                                                            <div class="product__card--content product__list--content">
                                                                ...
                                                                <a class="product__card--btn primary__btn" href="#">+ Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                    ...
                                    <nav class="pagination justify-content-center">
                                        ...
                                        @else
                                            <li class="page-item pagination__list">
                                                <a class="page-link pagination__item--arrow  link" href="{{ $products->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512">
                                                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M244 400L100 256l144-144M120 256h292"/>
                                                    </svg>
                                                    <span class="visually-hidden">page left arrow</span>
                                        ...
                                        @foreach ($products->getUrlRange(1, $products->lastPage()) as $page => $url)
                                            <li class="page-item {{ $page == $products->currentPage() ? 'active' : '' }} pagination__list">
                                                <a class="page-link pagination__item link" href="{{ $url }}">{{ $page }}</a>
                                            </li>
                                        @endforeach
                                        ...
                                        @if ($products->hasMorePages())
                                            <li class="page-item pagination__list">
                                                <a class="page-link pagination__item--arrow  link" href="{{ $products->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512">
                            ...
                            @else
                                <h2 class="font-bold text-center">{{__('Products Not Found')}}</h2>
                            @endif
                        </div>
                </div>
            </div>
