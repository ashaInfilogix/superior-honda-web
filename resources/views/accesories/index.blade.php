                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title">Accesories</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a href="/">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span>Accesories</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click','.priceButton', function() {
            ...
            $.ajax({
                url: '{{ route('accesories') }}?min_price=' + minPrice + '&max_price=' + maxPrice,
                method: 'GET',
                success: function(response) {
                    if(response.success == true) {
                        $('.all-products').html(response.productsHtml);
        ...
        $('#itemsPerPage').on('change', function() {
            ...
            $.ajax({
                url: '{{ route('accesories') }}?perPage='+ selectedValue,
                method: 'GET',
                success: function(response) {
                    if(response.success == true) {
                        $('.all-products').html(response.productsHtml);
        ...
        $('#sortBy').on('change', function() {
            ...
            $.ajax({
                url: '{{ route('accesories') }}?sort_by='+ selectedValue,
                method: 'GET',
                success: function(response) {
                    if(response.success == true) {
                        $('.all-products').html(response.productsHtml);
