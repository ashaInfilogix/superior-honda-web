                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home1-slider1-bg">
                            <div class="slider__content">
                                ...
                                <h2 class="slider__maintitle h1">{{$mainBanner->product_name}} <br> <span class="slider__maintitle--inner__text">{{$mainBanner->menu}}</span></h2>
                                <span class="slider__price--text text__secondary">{{number_format($mainBanner->product->cost_price,2)}}/$</span>   
                                <a class="primary__btn slider__btn" href="{{ route('products.show', $mainBanner->product_id) }}">
                                    Shop now
                            ...
                            <div class="hero__slider--layer">
                                <img class="slider__layer--img " src="{{ env('BASE_IMAGE_PATH')}}{{$mainBanner->banner_image }}" alt="slider-img">
                            </div>  
                        </div>
                    </div>
                    @endforeach
                                                    ...
                                                    <article class="product__card">
                                                        ...
                                                        <div class="product__card--thumbnail">
                                                            <a class="product__card--thumbnail__link display-block" href="{{ route('products.show', $product->id) }}">
                                                                ...
                                                                @endif src="{{ env('BASE_IMAGE_PATH')}}{{$imageValue->images }}" alt="product-img">
                                                                @php $i++; @endphp
                                                                @endforeach
                                                        ...
                                                        <h3 class="product__card--title"><a href="javascript:void(0)">{{$product->manufacture_name}} {{$product->product_name}}</a></h3>
                                                        <div class="product__card--price">
                                                            <span class="current__price">${{$product->cost_price}}</span>
                                                            <!-- <span class="old__price"> $362.00</span> -->
                                                        </div>
        ...
        <section class="product__section section--padding  pt-0">
            <div class="container">
                <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                    ...
                    <ul class="nav tab__btn--wrapper" role="tablist">
                        <li class="tab__btn--item" role="presentation">
                            <button class="tab__btn--link active" data-bs-toggle="tab" data-bs-target="#recent" type="button" role="tab" aria-selected="true" onclick="showAllProducts();"> All Products
                            </button>
                        </li>
                       <!--  <li class="tab__btn--item" role="presentation">
                        ...
                        <div class="col-lg-3">
                            <div class="sidebar__category">
                                <div class="choose__category--content">
                                    ...
                                    <ul class="choose__category--menu">
                                        ...
                                        <li class="choose__category--menu__list">
                                            ...
                                            <a class="choose__category--menu__link" href="javascript:void(0)" onclick="showProducts('{{$value['id']}}');">{{$key}}</a>
                                        </li>
                                        @endforeach
                                        <!-- <li class="choose__category--menu__list">
                                            <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="choose__category--banner position__relative">
                                    <a class="banner__thumbnail display-block" href="#"><img class="banner__thumbnail--img" src="{{ env('BASE_IMAGE_PATH')}}{{$sideBanner->banner_image }}" alt="banner-img">
                                        <div class="category__banner--content">
                                            <span class="category__banner--subtitle text__secondary">{{$sideBanner->submenu}}</span>
                                            <h2 class="category__banner--title">{{$sideBanner->product_name}}</h2>
                                            <p class="category__banner--desc">{{$sideBanner->menu}}</p>
                                            <span class="category__banner--price text__secondary">${{ number_format(optional($sideBanner->product)->cost_price, 2)}}</span>
                                        </div>
                                    </a>
                                </div>
                                @endforeach
                                ...
                                <div id="recent" class="tab-pane fade show active" role="tabpanel">
                                    <div class="product__wrapper">
                                        <div class="row mb--n30">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30 all-products product-{{$value['id']}}">
                                                <form action="{{ route('add-to-cart') }}" class="cart-submit" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <article class="product__card">
                                                        <div class="product__card--thumbnail">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="product__wrapper">
                                ...
                                <!-- <div class="col-lg-4 col-md-6 col-sm-6 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="#">
                                                <img class="product__card--thumbnail__img product__primary--img"
                                                    src="{{ asset('assets/images/product/main-product/product12.webp') }}"
                                                    alt="product-img">
                                                <img class="product__card--thumbnail__img product__secondary--img"
                                                    src="{{ asset('assets/images/product/main-product/product13.webp') }}"
                                                    alt="product-img">
                                            </a>
                                        ...
                                        <div class="product__card--content">
                                            ...
                                            <h3 class="product__card--title"><a href="#">Lorem ipsum dolor, sit amet
                                                    adipisi elit. </a></h3>
                                            <div class="product__card--price">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 d-none d-lg-block mb-30">
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            <a class="product__card--thumbnail__link display-block" href="#">
                                                <img class="product__card--thumbnail__img product__primary--img"
                                                    src="{{ asset('assets/images/product/main-product/product11.webp') }}"
                                                    alt="product-img">
                                                <img class="product__card--thumbnail__img product__secondary--img"
                                                    src="{{ asset('assets/images/product/main-product/product12.webp') }}"
                                                    alt="product-img">
                                        ...
                                        <div class="product__card--content">
                                            ...
                                            <h3 class="product__card--title"><a href="#">Taboriosam asnda et itaque
                                                    expcabo.</a></h3>
                                            <div class="product__card--price">
                            ...
                            <div class="mb--n30 row flex justify-content-center">
                                @if (count($banners) > 0)
                    ...
                    <div class="row">
                            ...
                            <div class="product__wrapper">
                                ...
                                <div class="row  mb--n30">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-30">
                                        <div class="banner__items position__relative">
                                            <a class="banner__thumbnail display-block" href="#"><img class="banner__thumbnail--img banner__max--height" src="{{ env('BASE_IMAGE_PATH')}}{{$banner->banner_image }}" alt="banner-img">
                                                <div class="banner__content style__right">
                                                    <span class="banner__content--subtitle text-white">{{$banner->product_name}}</span>
                                                    <h2 class="banner__content--title"><span class="banner__content--title__inner">PREMIUM</span> {{$banner->menu}}</h2>
                                                    <span class="banner__content--price">${{number_format($banner->product->cost_price, 2)}}</span>
                                                    <a  href="{{route('products.show', $banner->product_id)}}" class="banner__content--btn">Buy now 
                                                        <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="banner__sidebar position__relative">
                                <a class="banner__thumbnail display-block" href="#"><img class="banner__thumbnail--img" src="{{ env('BASE_IMAGE_PATH')}}{{$banner->banner_image }}" alt="banner-img">
                                    <div class="banner__content style__top">
                                        <span class="banner__content--subtitle text__secondary">{{$banner->submenu}}</span>
                                        <h2 class="banner__content--title">{{$banner->product_name}} <br> <span class="banner__content--title__inner">{{$banner->menu}}</span></h2>
